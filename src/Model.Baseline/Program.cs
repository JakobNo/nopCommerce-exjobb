...
public class ModelBaseline : BaseNopTest
{
    ...
    public static void Main(String[] args)
    {
        ...
        {
            // CustomProperties = System.Collections.Generic.Dictionary`2[System.String, System.Object],
            PageNumber = 0,
            PageSize = 0,
            TotalItems = 0,
            TotalPages = 0,
        ...
        var result = catalogController.Category(1, command);
